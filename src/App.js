        ...
        <div className="max-w-7xl mx-auto px-8 py-8">
          ...
          {activeMenuItem === 'admin-dashboard' && user.role === 'admin' && (
            <PlaceholderPage 
              ...
              description="Beheer klanten, bekijk statistieken en configureer het systeem."
            />
          )}

          {/* Admin Clients */}
          {activeMenuItem === 'clients' && user.role === 'admin' && (
            <PlaceholderPage 
          ...
          {/* Admin Settings */}
          {activeMenuItem === 'admin-settings' && user.role === 'admin' && (
            <PlaceholderPage 
